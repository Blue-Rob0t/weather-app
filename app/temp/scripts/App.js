...
/***/ (function(module, exports, __webpack_require__) {
	...
	function geoLocation(location) {
	  ...
	  navigator.geolocation.getCurrentPosition(function (position, location) {
	    ...
	    var theUrl = location || 'http://api.openweathermap.org/data/2.5/weather?lat=' + lat + '&lon=' + lon + '&APPID=' + DOM.APIKEY;
	...
	function cityName() {
	  ...
	  document.querySelector('#submit').addEventListener('click', function () {
	    ...
	    var apicall = 'api.openweathermap.org/data/2.5/weather?q=' + inputValue + ',us&APPID=' + DOM.APIKEY;
